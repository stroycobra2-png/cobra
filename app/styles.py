...
def get_stylesheet(theme="dark"):
    if theme == "light":
        ...
        * { outline:none; }
        ...
        QWidget { color:#182033;font-family:"Segoe UI";font-size:14px;background:transparent; }
    ...
    * { outline:none; }
    ...
    QWidget { color:#EDF1FA;font-family:"Segoe UI";font-size:14px;background:transparent; }
